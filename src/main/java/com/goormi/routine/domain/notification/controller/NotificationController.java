...
public class NotificationController {
    ...
    public ResponseEntity<Page<NotificationResponse>> getNotifications(
        ...
        Page<NotificationResponse> notifications = notificationService.getNotificationsByReceiver(receiverId, pageable);
    ...
    public ResponseEntity<Page<NotificationResponse>> getNotificationsByType(
            ...
            @PageableDefault(size = 20) Pageable pageable) {
        Page<NotificationResponse> notifications = notificationService.getNotificationsByNotificationType(receiverId, notificationType, pageable);
        return ResponseEntity.ok(notifications);
    }
